 ...
 * Original file: I:\\WorkSpace06\\osc-android-app\\src\\net\\oschina\\app\\service\\INoticeService.aidl
 */
...
{
private static final java.lang.String DESCRIPTOR = "net.oschina.app.service.INoticeService";
...
/**
 * Cast an IBinder object into an net.oschina.app.service.INoticeService interface,
 * generating a proxy if needed.
 */
public static net.oschina.app.service.INoticeService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof net.oschina.app.service.INoticeService))) {
return ((net.oschina.app.service.INoticeService)iin);
}
return new net.oschina.app.service.INoticeService.Stub.Proxy(obj);
}
...
private static class Proxy implements net.oschina.app.service.INoticeService
{
