...
//            ButterKnife.inject(this, view);
            author = (TextView) view.findViewById(R.id.tv_tweet_name);
            time = (TextView) view.findViewById(R.id.tv_tweet_time);
            content = (TweetTextView) view.findViewById(R.id.tweet_item);
            commentcount = (TextView) view.findViewById(R.id.tv_tweet_comment_count);
            platform = (TextView) view.findViewById(R.id.tv_tweet_platform);
            face = (AvatarView) view.findViewById(R.id.iv_tweet_face);
            image = (ImageView) view.findViewById(R.id.iv_tweet_image);
            likeState = (ImageView) view.findViewById(R.id.iv_like_state);
            del = (TextView) view.findViewById(R.id.tv_del);
            likeUsers = (TextView) view.findViewById(R.id.tv_likeusers);
            likeOption = view.findViewById(R.id.ll_like);
