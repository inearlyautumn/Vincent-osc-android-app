...
//        ButterKnife.inject(this, view);
        ...
        mTvRecordTime = (TextView) view.findViewById(R.id.tv_software_recordtime);
        mIvRecommended = (ImageView) view.findViewById(R.id.iv_recommended);
        mTvTitle = (TextView) view.findViewById(R.id.tv_title);
        mTvAuthor = (TextView) view.findViewById(R.id.tv_software_author);
        llAuthor = view.findViewById(R.id.ll_author);
        lineAuthor = view.findViewById(R.id.line_author);
