...
//        ButterKnife.inject(this, view);
    ...
    public void initView(View view) {
        ...
        mTvFans = (TextView) view.findViewById(R.id.tv_follower);
        mMesView = view.findViewById(R.id.tv_mes);
        mErrorLayout = (EmptyLayout) view.findViewById(R.id.error_layout);
        mQrCode = (ImageView) view.findViewById(R.id.iv_qr_code);
        mUserContainer = view.findViewById(R.id.ll_user_container);
        mUserUnLogin = view.findViewById(R.id.rl_user_unlogin);
