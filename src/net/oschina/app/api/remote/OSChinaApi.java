...
//	      ApiHttpClient.get("action/api/tweet_list", params, handler);
    ...
    public static void getTweetLikeList(AsyncHttpResponseHandler handler) {
    	...
    	ApiHttpClient.getLocal("oschina/list/my_tweet_like_list/page.xml", handler);
...
//        ApiHttpClient.get("action/api/active_list", params, handler);
    ...
    public static void getFriendList(int uid, int relation, int page,
        ...
        RequestParams params = new RequestParams();
        params.put("uid", uid);
    	ApiHttpClient.getLocal(String.format("oschina/list/friends_list%d/page%d.xml", relation, page), params, handler);
...
//        ApiHttpClient.get("action/api/friends_list", params, handler);
    ...
    public static void getFavoriteList(int uid, int type, int page,
        ...
        RequestParams params = new RequestParams();
        params.put("uid", uid);
    	ApiHttpClient.getLocal(String.format("oschina/list/favorite_list%d/page%d.xml", type, page), params, handler);
...
//        ApiHttpClient.get("action/api/comment_list", params, handler);
    ...
    public static void getUserBlogList(int authoruid, final String authorname,
        ...
        RequestParams params = new RequestParams();
        params.put("uid", uid);
        ApiHttpClient.getLocal(String.format("oschina/list/userblog_list/page%d.xml", pageIndex), params, handler);
...
//        ApiHttpClient.get("action/api/my_information", params, handler);
        ...
        RequestParams params = new RequestParams();
        params.put("uid", uid);
    	ApiHttpClient.getLocal("oschina/information/my_information.xml", params, handler);
    }
...
//        ApiHttpClient.get("action/api/blog_detail", params, handler);
    ...
    public static void getSoftwareDetail(String ident,
            AsyncHttpResponseHandler handler) {
    	RequestParams params = new RequestParams();
    	ApiHttpClient.getLocal(String.format("oschina/detail/software_detail/%s.xml", ident.replaceAll(" ", "")), params, handler);
...
//        ApiHttpClient.get("action/api/software_detail", params, handler);
    ...
    public static void getPostDetail(int id, AsyncHttpResponseHandler handler) {
        RequestParams params = new RequestParams();
        ApiHttpClient.getLocal("oschina/detail/post_detail/"+id+".xml", params, handler);
...
//        ApiHttpClient.get("action/api/post_detail", params, handler);
    ...
    public static void getTweetDetail(int id, AsyncHttpResponseHandler handler) {
    	// 从本地服务器获取
    	RequestParams params = new RequestParams();
    	ApiHttpClient.getLocal(String.format("oschina/detail/tweet_detail/%d.xml", id), params, handler);
...
//        ApiHttpClient.get("action/api/tweet_detail", params, handler);
    ...
    public static void getMessageList(int uid, int pageIndex,
        ...
        RequestParams params = new RequestParams();
        params.put("uid", uid);
        ApiHttpClient.getLocal(String.format("oschina/list/message_list/page%d.xml", pageIndex), params, handler);
...
//    	活动:
//    		近期活动:
//    		http://www.oschina.net/action/api/event_list?uid=-1&pageIndex=0&pageSize=20
//    		本地路径:oschina/list/event_list/page0.xml
//
//    		我的活动:(需要cookie)
//    		http://www.oschina.net/action/api/event_list?uid=993896&pageIndex=0&pageSize=20 
//    		本地路径:oschina/list/my_event_list

    	RequestParams params = new RequestParams();
    	if(uid == -1){
    		ApiHttpClient.getLocal(String.format("oschina/list/event_list/page%d.xml", pageIndex), params, handler);
    	}else {
    		ApiHttpClient.getLocal(String.format("oschina/list/my_event_list/page%d.xml", pageIndex), params, handler);
		}
