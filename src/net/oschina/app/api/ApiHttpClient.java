...
public class ApiHttpClient {
    ...
    public static String HOST = "www.oschina.net";
    public static String API_URL = "http://www.oschina.net/%s";
    //本地服务器地址
    public static String HOST_LOCAL = "http://192.168.56.1:8080/";
    public static String API_URL_LOCAL = HOST_LOCAL+"%s";
